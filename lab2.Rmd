...
#Autoplot() takes the data that you give it and assumes the type of plot you would want to make from it:
...
### Read in from URL, `lubridate()`, `mutate()`, make a graph with months in logical order
...
ggsave(here("fig", "graph_c_jh.png"), width = 5, height = 6)
